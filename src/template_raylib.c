...
#define NUM_TEXT_OFFSET 1.0 + 0.5*plot->text_percent_offset
    ...
    if (plot->flags & IMP_AXIS_Z) {
        ...
        s32 align_v = IMP_TEXT_ALIGN_MIDDLE;
...
#define CULL_FAR 10000
        ...
        Rectangle rect = atlas_rect[ATLAS_FONT+'O'];
        rect = atlas_rect[IMP_MARKER_CIRCLE];
